  ...
  useEffect(() => {
    if (listing) {
      setFormData({
        ...
        description: listing.listing?.description || "", // Fixed typo (desciprtion -> description)
        location: listing.listing?.location || "",
        landmark: listing.listing?.landmark || "",
        userId: userId,
      });
    }
  }, [listing]);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-gray-500">
              Set a competitive price to attract guests
            </p>
          </div>
          ...
          <div className="col-span-2">
            ...
            <div
              className={`mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg transition-all duration-300 ${
                ...
                {preview ? (
                  <div className="mb-4">
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                      Looking good! Click below to change.
                    </p>
                  </div>
                ) : (
                  <svg
          ...
          <div className="col-span-2">
            ...
            ></textarea>
            <p className="mt-2 text-xs text-gray-500">
              Be descriptive! Help guests imagine their stay.
            </p>
          </div>
        </div>
